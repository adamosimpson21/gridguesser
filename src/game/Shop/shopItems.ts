...
export const SHOP_ITEMS: { [key: string]: shopItemType } = {
    ...
    REMOVE_BOMBS_BY_LUCK: {
        ...
        name: "Lucky Duster",
        description: `Removes up to 7 ${flavorConstants.ENEMY_NAME_PLURAL} based on luck`,
        cost: 11,
        effect: { bombNumberReduceByLuck: 7 },
        icon: 40,
        permanent: true,
        singleton: false,
        activated: false,
    ...
    REMOVE_TRASH_BY_LUCK: {
        ...
        name: "Lucky Bin",
        description: `Removes up to 5 Trash spots based on luck`,
        cost: 11,
    ...
    REMOVE_LIES_BY_LUCK: {
        ...
        description: `Removes up to 5 Lying Numbers based on luck`,
        cost: 11,
    ...
    REMOVE_TENTACLES_BY_LUCK: {
        ...
        description: `Removes up to 5 Tentacles based on luck`,
        cost: 17,
